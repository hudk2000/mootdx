...
class GetFinanceInfo(BaseParser):
    ...
    def parseResponse(self, body_buf):
        ...
        return OrderedDict([
            ...
            ('province', province), ('industry', industry),
            ('updated_date', updated_date), ('ipo_date', ipo_date),
            ("zongguben", _get_v(zongguben) * 10000),
            ("guojiagu", _get_v(guojiagu) * 10000),
            ("faqirenfarengu", _get_v(faqirenfarengu) * 10000),
            ("farengu", _get_v(farengu) * 10000), ("bgu", _get_v(bgu) * 10000),
            ...
            ("meigujingzichan", _get_v(baoliu1)), ("baoliu2", _get_v(baoliu2))
        ])
